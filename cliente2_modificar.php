...
include("cliente2_tabla.php");

$pagina = $_GET['pag'];
$correo = $_GET['correo'];

$querybuscar = mysqli_query($conn, "SELECT * FROM cliente2 WHERE correo = '$correo'");
...
<td colspan="2">
<?php echo "<a class='BotonesUsuarios' href=\"cliente2_tabla.php?pag=$pagina\">Cancelar</a>";?>
...
$querymodificar = mysqli_query($conn, "UPDATE cliente2 SET nom='$nom1',correo='$correo1',pass='$pass1' WHERE correo = '$correo1'");
echo "<script>window.location= 'cliente2_tabla.php?pag=$pagina' </script>";
